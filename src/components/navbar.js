                ...
                <div id="navMenu" className={`navbar-menu ${this.state.isOpen? ' is-active nav-dropdown' : ''}`}>
                    ...
                    <div className="navbar-end nav-icons">
                        <a className="navbar-item" rel="noopener noreferrer" href="https://www.linkedin.com/in/tgmathew" target="_blank">
                            <svg width="2em" height="2em" fill="currentColor" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a className="navbar-item" rel="noopener noreferrer" href="https://github.com/contejus" target="_blank">
                            <svg role="img" width="2em" height="2em" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <title>GitHub</title>
